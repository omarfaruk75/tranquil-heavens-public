...
const Footer = () => {
    return (
        <div>
            <footer className="footer footer-center p-10 bg-[#001b38] text-white rounded">
                <nav className="text-4xl font-bold text-center">Tranquil Havens</nav>
                <nav className="grid grid-flow-col gap-4 font-bold text-xl">
